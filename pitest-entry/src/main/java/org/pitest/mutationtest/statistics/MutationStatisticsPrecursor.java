...
class MutationStatisticsPrecursor {
    ...
    private Map<String, Integer> methodsStats = new HashMap<String, Integer>();
    ...
    public MutationStatistics toStatistics() {
        ...
        return new MutationStatistics(scores, totalMutations, totalDetected, this.numberOfTestsRun,
                methodsStats.get(MutationStatisticsListener.PARTIALLY_TESTED),
                methodsStats.get(MutationStatisticsListener.PSEUDO_TESTED));
    }
    ...
    public void setMethodsStats(Map<String, Integer> methodsStats) {
